...
router.get('/', function (req, res, next) {
    var db = new sqlite3.Database('mydb.sqlite3', sqlite3.OPEN_READWRITE | sqlite3.OPEN_CREATE, (err) => {
        if (err) {
...
router.post('/login', (req, res, next) => {
    var db = new sqlite3.Database('mydb.sqlite3', sqlite3.OPEN_READWRITE | sqlite3.OPEN_CREATE, (err) => {
        ...
        db.all(`SELECT * FROM user WHERE user_name = '${req.body.username}' and user_password ='${req.body.password}';`, function (err, rows) {
